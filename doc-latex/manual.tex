...
% paper size
\usepackage[showframe,lmargin=3cm,rmargin=3cm]{geometry}
% to include images
\usepackage{graphicx}
% math stuff
\usepackage{amsmath}
...
\newcommand{\CallInit}[2]{\vspace{1em}\tt{#1} \
                          \Call{#2}{parameters}\vspace{-1em}}
...
% new column type
\newcolumntype{L}[1]{p{#1}@{\hspace{-20pt}}}
