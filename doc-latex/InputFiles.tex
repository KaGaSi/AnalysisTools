...
that for the bead type's topmost atom line with the corresponding keyword. If
the keyword is missing from all atom lines, that characteristic is undefined.
The \tt{--detailed} command line option can, however, force some utilities to
distinguish bead types based on all bead's properties.
...
As an example, consider the following \vsf file that contains 11 beads and two
molecules:
