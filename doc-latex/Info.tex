...
Using the \tt{-i} option with an extra structure file asigns bead mass, charge,
...
bond types, angles and angle type can be added to the molecule types in the
original file. Using \tt{-i!} first exchanges beads in the original molecules
with those from the extra file (if the molecules have the same number of beads)
before adding the extra information. See \tt{Examples/Info} folder for examples;
note that this functionality can give unexpected results.
