...
into three types (and augment the names): \tt{A} and \tt{A_1} with masses equal
to 1 and 2, respectively, and \tt{A_2} with undefined mass (it remains undefined
because there is an ambiguity---should the last bead have mass 1 or 2?). On the
other hand, the \tt{B} beads would be assigned the same bead type with mass
equal to 2 (there is no ambiguity because only one mass is specified for the
\tt{B} beads).
