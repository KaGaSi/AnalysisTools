...
Section~\ref{sec:AggNumber} for general definitions of averages).
...
Similarly to \texttt{AggNumber}, the definition of aggregate size is
flexible -- see Section~\ref{sec:AggNumber} for explanations of the
