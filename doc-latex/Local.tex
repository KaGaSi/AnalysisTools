...
For now, only shifted Sutton-Chen potential is implemented (see below).

\TODO the number of bins will be constant!
...
\tt{--cog} or \tt{--com}, geometric centre of all beads or the centre of mass,
respectively, is used instead. While the utility can cope with fairly large size
changes to the box (getting twice as large in every direction), it should be
noted that the utility averages each bin of the profile with the total number of
used steps (i.e., if the box get bigger, the new bins will undercount the beads).
The resulting profiles have 0 at the specified average centre (either average
centre of the box, average geometric centre for \tt{--cog} option or average
centre of mass for \tt{--com} option).
