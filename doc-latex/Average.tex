...
\subsection{$\boldsymbol{\tau}$ estimation via -tau option}
...
the number of datapoints per block to average, $k$, is supplied, and the utility
...
\vspace{1em}
\noindent
\tt{Average <input> <output> <column(s)>  <options>}
