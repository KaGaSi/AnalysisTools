...
% Box %{{{
\subsubsection{Simulation box size}\label{ssub:Box}
\ttb{typedef struct Box \{<members>\} BOX;}\\
\vspace{-1.75em}
\begin{longtable}{L{0.43\textwidth}p{0.615\textwidth}}
  \toprule
  member                         & explanation \\
  \midrule
...
% BeadType %{{{
\subsubsection{Information about bead types}\label{ssub:BeadType}
\ttb{typedef struct BeadType \{<members>\} BEADTYPE;} \\
\vspace{-1.75em}
\begin{longtable}{L{0.24\textwidth}p{0.805\textwidth}}
  \toprule
  member                & explanation\\
  \midrule
...
% Bead %{{{
\subsubsection{Information about individual beads}\label{ssub:Bead}
\ttb{typedef struct Bead \{<members>\} BEAD;} \\
\vspace{-1.75em}
\begin{longtable}{L{0.35\textwidth}p{0.695\textwidth}}
  \toprule
  member                & explanation \\
  \midrule
  \ttb{(int)Type}               & bead type index corresponding to a
                                  \ttb{struct BeadType} array index\\
  \ttb{(int)Molecule}           & molecule index corresponding to a \ttb{struct
                                  Molecule} array index or $-1$ for an unbonded
                                  bead\\
  ...
  \ttb{(struct Vector)Velocity}$^\dagger$ & velocity of the bead\\
  \bottomrule
\end{longtable}
\note{$^\P$\TODO will be removed\\
...
% MoleculeType %{{{
\subsubsection{Information about molecule types}\label{ssec:MoleculeType}
\ttb{typedef struct MoleculeType \{<members>\} MOLECULETYPE;} \\
\vspace{-1.75em}
\begin{longtable}{L{0.27\textwidth}p{0.775\textwidth}}
  \toprule
  member                      & explanation \\
  \midrule
...
% Molecule %{{{
\subsubsection{Information about individual molecules}\label{ssec:Molecule}
...
% Aggregate %{{{
\subsubsection{Information about individual aggregates}\label{ssub:Aggregates}
