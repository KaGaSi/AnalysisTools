...
\enquote{sliced} into blocks with width \tt{<width>} (see below), and numbers of
different bead types are counted in each \enquote{slice}. Or to put it more
rigorously, a density profile for a bead type $i$ along an axis $\alpha$,
$\rho(\alpha)$, is calculated as
\begin{equation}
