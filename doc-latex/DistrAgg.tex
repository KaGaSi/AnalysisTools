...
\tt{<file>-ratio\_<size>.txt} file; that is, two files are created for each
...
\begin{enumerate}[nosep]
  ...
  \item if \tt{-only Mol\_A Mol\_B} and \tt{-x Mol\_A} are combined
    with \tt{-m Mol\_A}, the size of the one detected aggregate would be 1
\end{enumerate}
\vspace{1em}
...
ratios, that is \tt{Mol\_A}$/$\tt{Mol\_B}, \tt{Mol\_A}$/$\tt{Mol\_C}, and
\tt{Mol\_B}$/$\tt{Mol\_C}.
    ...
    \begin{itemize}[nosep,leftmargin=5pt]
      ...
      \item second to last line: column headers for overall averages
        \begin{itemize}[nosep,leftmargin=10pt]
          ...
          \item average number of aggregates per timestep, \tt{<n\_agg>}
        \end{itemize}
