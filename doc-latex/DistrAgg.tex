...
into the \tt{<distr>} file. Overall averages are appended as comments (with
commented legend) to both \tt{<output avg>} and \tt{<distr>} files.
...
The \tt{<avg>} contains averages for all timesteps regardless of \tt{-st},
