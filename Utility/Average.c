...
static const struct OptSpec opts[] = {
  ...
  {"-tau", "<int>", "estimate tau mode - number of blocks to split data into"},
  {"-b", "<int>", "block mode - number of datapoints per block"},
...
int main ( int argc, char** argv ) {
  ...
  commons.start--; // discarded steps rather than starting step //TODO: change
