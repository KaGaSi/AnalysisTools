...
const struct HelpHelp HelpDesc = {
    "Aggregates-NotSameBeads utility works in the same way as Aggregates "
    "utility, but it does not use contacts between beads of the same type; "
    "i.e., if bead  types 'A' and 'B' are given, it considers only 'A-B' "
    "pairs.",
